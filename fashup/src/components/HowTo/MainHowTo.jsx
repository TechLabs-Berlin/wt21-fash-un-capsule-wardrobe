        ...
        <Grid container direction="row" justifyContent="center" alignItems="center" spacing={8} sx={{ height: "500px"}}>
            <Grid item>
                <Box component="div" sx={{mt: "30px"}}>
                    ...
                    <Typography sx={{ pt: "50px" }}>Upload a single Picture with <br/> your favourite clothing item</Typography>
                </Box>
            </Grid>
            ...
            <Grid item>
                <Box component="div" sx={{mt: "30px"}}>
                    ...
                    <Typography sx={{ pt: "50px" }}>Click on a suggested similar <br/> clothing item</Typography>
                </Box>
            </Grid>
            ...
            <Grid item>
                <Box component="div" sx={{mt: "30px"}}>
                    ...
                    <Typography sx={{ pt: "50px" }}>Click the photo to navigate to the <br/> onlineshop with the selected item </Typography>
                </Box>
            </Grid>
          </Grid>
        </Grid>
